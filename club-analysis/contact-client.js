// LP-specific derivative; rebuild with work/build-club-qr.mjs.
(() => {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', async (event) => {
      ...
      try {
        ...
        const redirectUrl = window.clubEntrySource === 'qr' ? '/club-analysis/thanks/qr/' : '/club-analysis/thanks/';
        if (typeof window.gtag === 'function') {
          ...
          if (window.clubEntrySource === 'qr') window.gtag('event', 'club_qr_lead', {content_group: 'club_analysis', entry_source: 'qr'});
          window.gtag('event', 'generate_lead', {
            event_category: 'contact',
            event_label: 'club_contact',
